...
export default function BasicDetails({ nextStep, prevStep }) {
  ...
  const { ideaName, ideaDescription, category } = useSelector(
    (state) => state.form
  );
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          id="ideaName"//Unique id for the input field
          name="ideaName"//Name matches the corresponding field
          value={ideaName}
      ...
      <div>
        ...
        <input
          type="text"//Input type is text
          id="category"//Unique id for the input field
          name="category"
          value={category}
